...
function TermsAndConditions() {
  return (
    <div style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif', padding: '1em' }}>
      ...
      <p>These terms and conditions apply to the Ev-ALGO Trages app (hereby referred to as "Application") for mobile devices that was created by (hereby referred to as "Service Provider") as a Free service.</p>
      ...
      <h2>Contact Us</h2>
      <p>If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact the Service Provider at sritechus@gmail.com.</p>
    </div>
  );
}
